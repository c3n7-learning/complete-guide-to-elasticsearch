...
- Usually the motivation is to improve performance/throughput and data-bandwidth/transfer costs.
- e.g. we could want to retreive IDs only, which will then retreive from another data source
